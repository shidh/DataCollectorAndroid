 ...
 */
public class CollectionSwipeAdapter extends BaseSwipeAdapter {
    private Activity activity;
    private List<ImejiCollection> dataItems;

    public CollectionSwipeAdapter(Activity activity, List<ImejiCollection> dataItems) {
    ...
    public void fillValues(int position, View convertView) {
        ...
        if(dataItems.size()>0) {
            ...
            ImejiCollection m = dataItems.get(position);
